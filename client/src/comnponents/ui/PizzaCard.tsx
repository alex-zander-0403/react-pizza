...
//
function PizzaCard({ id, imageUrl, title, types, sizes, price, category, rating }: PizzaCardPropsType): JSX.Element {
  //
    ...
    <div className="pizza-card-wrapper">
      <div className="pizza-card">
        ...
        <div className="pizza-card__selector">
          ...
          <ul>
            {types.map((type, i) => (
              <li className={activeType === i ? "active" : ""} key={i} onClick={() => setActiveType(i)}>
                {typeNames[type]}
              </li>
            ))}
          </ul>
          ...
          <ul>
            {sizes.map((size, i) => (
              <li className={activeSize === i ? "active" : ""} key={i} onClick={() => setActiveSize(i)}>
                {size} см
              </li>
            ))}
          </ul>
